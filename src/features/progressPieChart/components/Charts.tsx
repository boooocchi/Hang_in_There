...
const Charts = () => {
  ...
  return (
    <div className="xs:h-full xs:w-1/2 w-full bg-gray shadow-[5px_10px_10px_-5px_rgba(0,0,0,0.3)] p-sm xs:p-md rounded-lg flex flex-col gap-sm relative max-xs:h-[250px]">
