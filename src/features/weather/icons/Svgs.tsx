...
export const WeatherIcon = ({ description }: WeatherDescription) => {
  switch (description) {
    case 'clear sky':
      return sunny;
    case 'few clouds':
...
const sunny = (
  <svg
    ...
    className="fill-accentOrangeRed stroke-accentOrangeRed  w-[48px]"
    viewBox="0 0 101 101"
    id="sun"
  >
...
const cloudy = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="8 10 115 110" id="cloud" className="w-[48px]">
    <path
      className="fill-accentOrangeRed stroke-accentOrangeRed"
...
const snowy = (
  <svg xmlns="http://www.w3.org/2000/svg" version="1.0" id="snow">
    <path
      fill="#010101"
    ...
    ></path>
    <path fill="#010101" d="M17.494 12.35H6.506a.35.35 0 0 1 0-.7h10.988a.35.35 0 0 1 0 .7z"></path>
    <path
      fill="#010101"
...
const misty = (
  <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 48 48" viewBox="0 0 48 48" id="mist">
    <rect width="34" height="4" x="4" y="10" fill="#b0bec5"></rect>
    <rect width="29" height="4" x="4" y="26" fill="#b0bec5"></rect>
    <rect width="28" height="4" x="16" y="18" fill="#b0bec5"></rect>
    <rect width="35" height="4" x="9" y="34" fill="#b0bec5"></rect>
  </svg>
);

const fewClouds = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" id="cloud-sun">
...
const thunderStorm = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" id="thunderstorm">
