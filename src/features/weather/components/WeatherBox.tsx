  ...
  return (
    ...
    >
      ...
      <div className="w-full flex-grow flex flex-col xs:justify-center items-center">
        <div className="flex max-xs:flex-col xs:gap-xs xs:justify-center items-center text-xl w-full xs:w-1/2">
        ...
        <div className="w-2/3 xs:w-1/2 flex justify-center gap-xs items-center">
          ...
          <div className="flex w-1/2 xs:flex-col items-center max-xs:w-2/5">
            ...
            <div className="flex flex-col xs:flex-row justify-center gap-1 xs:gap-1 text-sm max-xs:w-full">
...
const WeatherBox = ({ weatherData }: WeatherData) => {
  return (
    <div className="w-full h-full shadow-[5px_10px_10px_-5px_rgba(0,0,0,0.3)] rounded-lg flex flex-col  bg-gray p-sm xs:p-md">
