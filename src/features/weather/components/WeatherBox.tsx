...
const WeatherBox = ({ weatherData }: WeatherData) => {
  return (
    <div className="w-full h-full shadow-[5px_10px_10px_-5px_rgba(0,0,0,0.3)] rounded-lg flex items-center justify-center bg-gray py-md max-xs:px-sm">
      {weatherData ? (
        <div className="flex flex-col gap-sm xs:flex-row  items-center justify-center xs:items-start w-full">
          <div className="xs:w-1/3 w-full flex xs:flex-col gap-sm xs:gap-xs justify-center items-center text-xl ">
          ...
          <div className="xs:w-1/3 w-full flex xs:flex-col h-full gap-xs items-center justify-center">
            <div className="xs:text-2xl text-xl ml-1 font-boldest xs:h-[50px] max-xs:w-1/2 flex items-center justify-center leading-[1.3]">
