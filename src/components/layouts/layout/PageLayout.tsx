...
const PageLayout: React.FC<Children> = ({ children }) => {
  ...
  return (
    <div className="w-full h-full flex items-center">
      ...
      <div className="flex flex-col h-full  px-[15px] pt-md pb-xl xs:px-4xl xs:py-2xl w-full bg-darkGray xs:gap-[30px] gap-[20px] xs:min-h-[750px] xs:max-h-[800px] overflow-visible xs:overflow-hidden max-xs:min-h-svh">
        <Header />
