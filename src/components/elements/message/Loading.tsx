...
const Loading = ({ size }: { size?: string }) => {
  return (
    <div className="w-full flex items-center justify-center h-full flex-col gap-md">
      {size === 'large' ? (
        <div className="flex flex-col justify-center mb-md">
          <svg
            className="inline text-lighterOrange rounded-md w-[300px] h-[300px] gap-4"
          ...
          >
            ...
            <path
              ...
              fill="#cbcbcb"
            />
            <polygon points="536.719 564.419 526.8 586.013 521.133 580.277 536.719 564.419" opacity="0.1" />
            ...
            <path
              ...
              fill="#3f3d56"
            />
            <polygon points="609.091 484 477.091 484 461.091 420 625.091 420 609.091 484" fill="#3f3d56" />
          ...
          <span className="animate-pulse text-bolder text-center text-xl">Loading...</span>
        </div>
      ) : (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          ...
          strokeWidth="2"
          stroke="currentColor"
          className="inline text-lighterOrange  animate-spin  rounded-md w-[30px] h-[30px]"
        >
          <path
            strokeLinecap="round"
