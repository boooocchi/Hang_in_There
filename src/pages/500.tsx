  ...
  return (
    <MainLayout>
      <div className="h-full w-full flex flex-col justify-center items-center">
        <h1 className={`${titleFont.className} text-2xl`}>500 - Server Error</h1>
        <svg
        ...
        >
          ...
          <rect x="271.60911" y="150" width="16" height="16" fill="#10645b" opacity="0.4" />
          <rect x="294.60911" y="150" width="16" height="16" fill="#10645b" opacity="0.8" />
          <rect x="317.60911" y="150" width="16" height="16" fill="#10645b" />
          <rect x="271.60911" y="251" width="16" height="16" fill="#10645b" opacity="0.4" />
          <rect x="294.60911" y="251" width="16" height="16" fill="#10645b" opacity="0.8" />
          <rect x="317.60911" y="251" width="16" height="16" fill="#10645b" />
          <rect x="271.60911" y="352" width="16" height="16" fill="#10645b" opacity="0.4" />
          <rect x="294.60911" y="352" width="16" height="16" fill="#10645b" opacity="0.8" />
          <rect x="317.60911" y="352" width="16" height="16" fill="#10645b" />
