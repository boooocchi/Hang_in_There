        ...
        <section className="flex flex-col h-full w-[99%]   gap-6">
          <div className="h-[35%] flex gap-6 justify-between font-bold">
            <div className="h-full w-full  group rounded-md shadow-[3px_3px_5px_1px_#aaa] bg-lightGreen relative overflow-hidden p-md">
              ...
              <h2
                className={`text-xl  text-richGreen relative   transition-all duration-300 group-hover:opacity-100 ease-in  w-1/2 font-extraBold  ${titleFont.className}`}
              >
                <p>
                  Your <br /> Wardrobe
                </p>
                <Link
                  href="/wardrobe"
                  className={`bg-accentOrange text-white rounded-md p-sm  text-center text-sm mt-3 py-[7px] inline-block font-boldest w-2/3 ${mainFont.className}`}
                >
                  View
                </Link>
              </h2>
            ...
            <div className="h-full  w-full  overflow-hidden group rounded-md shadow-[3px_3px_5px_1px_#aaa] bg-lightGreen relative p-md ">
              ...
              >
                ...
                >
                  <p>
                    Register <br /> Your Peace
                  </p>
                  <Link
                    href="/registerPiece"
                    className={`bg-accentOrange text-white font-boldest rounded-md p-sm  text-center text-sm mt-3 py-[7px] inline-block  w-3/5 ${mainFont.className}`}
                  >
                    Register
                  </Link>
                </h2>
            ...
            <div className="h-full  w-full  shadow-[3px_3px_5px_1px_#aaa]  relative overflow-hidden group rounded-md bg-lightGreen p-md ">
              ...
              <h2
                className={`text-xl  text-richGreen relative   transition-all duration-300 group-hover:opacity-100 ease-in  w-2/3 font-extraBold  ${titleFont.className} whitespace-nowrap`}
              >
                <p>Dendo Outfit</p>
                <Link
                  href={`/dendoOutfit/${userid}`}
                  className={`bg-accentOrange font-boldest rounded-md p-sm  text-center text-sm mt-3 py-[7px] inline-block text-white w-3/5 ${mainFont.className}`}
                >
                  View
                </Link>
              </h2>
            ...
            <div className="h-full  w-full shadow-[3px_3px_5px_1px_#aaa]   relative overflow-hidden group rounded-md   bg-lightGreen p-md ">
              ...
              >
                ...
                <Link
                  href="/dendoOutfit"
                  className={`bg-accentOrange font-boldest rounded-md p-sm text-white  text-center text-sm mt-3 py-[7px] inline-block  w-3/5 ${mainFont.className}`}
                >
                  Look
                </Link>
              </h2>
          ...
          <div className="h-[65%] w-full flex gap-6 ">
            <div className="h-full w-1/2  flex flex-col gap-6">
              <div className="w-full h-[40%] border-1 border-lightGreen rounded-md overflow-hidden flex">
                <h2
                  className={` text-lg  text-center h-full items-center flex text-richGreen bg-white border-r border-lightGreen font-extraBold p-lg w-[150px] min-w-[150px] `}
                >
                  <span>Today&apos;s Weather</span>
                </h2>
                <WeatherBox weatherData={weatherData} />
              </div>
              <div className="w-full overflow-hidden h-[60%] rounded-md   flex gap-6 border-1 border-lightGreen ">
                <div className="w-full h-full   p-0  flex overflow-hidden ">
                  <h2 className=" text-lg leading-[16px] text-center h-full items-center flex justify-center text-richGreen bg-white p-lg w-[150px] min-w-[150px] font-extraBold border-r border-r-lightGreen">
                    Wish List
                  </h2>
            ...
            <div className="h-full w-1/2   bg-white p-lg rounded-md flex flex-col gap-1 justify-center border-1 border-lightGreen">
